...
function drawBlock(col, row, color) {
  ...
  '#e3a8b5', // rosa médio
  '#c4a1d3', // lilás escuro
  '#9fc2d9', // azul pastel escuro
  '#8cc7a1', // verde menta escuro
  '#e8d47b', // amarelo queimado suave
  '#e4a58b', // pêssego mais quente
  '#bdaeb6', // lilás acinzentado
  '#9bbd98', // verde-acinzentado
  '#d4c88a', // creme escuro
  '#cfc6b8'  // bege acinzentado
];
  ...
  if (document.activeElement === nameInput) {
    ...
    if (['A', 'G', 'T', 'M'].includes(e.key.toUpperCase())) {
      ...
      if (uniqueLetters.length === 4 && uniqueLetters.every(letter => ['A', 'G', 'T', 'M'].includes(letter))) {
       ...
       // ====== EASTER EGG DE GERALDO ======
 // Escurece apenas o fundo do tabuleiro (canvas principal)
  mainCanvas.style.transition = 'background-color 0.8s ease';
  mainCanvas.style.backgroundColor = '#1a1024'; // roxo escuro elegante
  nextCanvas.style.backgroundColor = '#221430'; // mesmo tom no canvas da próxima peça
  
  // Deixa o resto do jogo com um leve brilho mágico
  document.body.style.transition = 'filter 1s ease';
  document.body.style.filter = 'brightness(1.05) hue-rotate(25deg)';
  // ====== FIM DO EASTER EGG DE GERALDO ======
